    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('support', EntityType::class, [
				...
				'label'=>'Support', 
				'placeholder'=>'Choisissez un support',
				'multiple'=>true,
				'attr'=>['class'=>'selectpicker','data-live-search'=>'true','data-selected-text-format'=>'count','data-actions-box'=>'true','title'=>'Sélectionner vos plateformes']])
            ->add('availableGames', EntityType::class,['required'=>false,'label'=>"Liste des jeux ",'class'=>AvailableGames::class, 'choice_label'=>'gameName','multiple'=>true,'attr'=>['class'=>'selectpicker','data-live-search'=>'true','data-selected-text-format'=>'count','data-actions-box'=>'true','title'=>'Sélectionner vos jeux']])
